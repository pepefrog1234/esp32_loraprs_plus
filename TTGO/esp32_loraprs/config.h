...
// select between client mode and APRS-IS gate mode (客戶端)
...
#ifdef USE_SX126X
#define CFG_LORA_PIN_B        39          // (sx127x - dio1, sx126x/sx128x - busy)//這個號碼錯誤號我debug好久
...
// Bluetooth
#define CFG_BT_NAME           "TTGO"   // set to empty to disable Bluetooth
